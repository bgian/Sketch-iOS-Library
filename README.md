...
Have a style worth replicating? [Suggest a style](https://github.com/bgian/Sketch-iOS-Library#suggest-a-style).
...
3. Describe the iOS style that should be replicated
